...
class UserRegistrationForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ['username','password1','password2','first_name','last_name','email', 'account_type','birth_date','gender', 'postal_code','city','street_address', 'country'] # form a kon kon field thakbe seta define kore dilum!
